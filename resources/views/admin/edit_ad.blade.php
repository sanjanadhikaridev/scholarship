            ...
            <div id="page-wrapper">
                ...
                <div class="row">
                    <div class="col-md-10 col-xs-12">
                        ...
                        <div class="form-group">
                            <label for="ad_title" class="col-sm-4 control-label">@lang('app.ad_coupon_code')</label>
                            <div class="col-sm-8">
                                <input type="text" class="form-control" id="coupon_code" name="coupon_code" placeholder="@lang('app.ad_coupon_code')" value="{{ old('coupon_code') ? old('coupon_code') : $ad->coupon_code }}">
                                <p class="text-info"> @lang('app.ad_coupon_code')</p>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="ad_title" class="col-sm-4 control-label">@lang('app.expiry_date')</label>
                            <div class="col-sm-8">
                                <input type="date" class="form-control" id="expiry_date" name="expiry_date" value="{{ old('expiry_date') ? old('expiry_date') : $ad->expiry_date }}" placeholder="@lang('app.expiry_date')">
                                <p class="text-info"> @lang('app.expiry_date')</p>
                            </div>
                        </div>
                        ...
                        <div class="form-group  {{ $errors->has('price')? 'has-error':'' }}">
                            ...
                            <div class="col-md-4">
                                <div class="input-group">
                                    ...
                                    <input type="text" placeholder="@lang('app.ex_price')" class="form-control" name="discount_price" id="discount_price" value="{{ old('discount_price')? old('discount_price') : $ad->discount_price }}">
                                </div>
                            </div>
                            <div class="col-sm-8 col-md-offset-4">
                                {!! $errors->has('price')? '<p class="help-block">'.$errors->first('price').'</p>':'' !!}
                        ...
                        <div class="form-group">
                            <label for="ad_title" class="col-sm-4 control-label">@lang('app.seller_url')</label>
                            <div class="col-sm-8">
                                <input type="text" class="form-control" id="seller_url" name="seller_url" placeholder="@lang('app.seller_url')" value="{{ old('seller_url')? old('seller_url') : $ad->seller_url }}">
                            </div>
                        </div>
