                    ...
                    <div class="col-md-10 col-xs-12">
                        ...
                        <form action="" id="adsPostForm" class="form-horizontal" enctype="multipart/form-data" method="post"> @csrf
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" id="ad_title" name="coupon_code" placeholder="@lang('app.ad_coupon_code')">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="date" class="form-control" id="expiry_date" name="expiry_date" placeholder="@lang('app.expiry_date')">
                            ...
                            <div class="form-group  {{ $errors->has('price')? 'has-error':'' }}">
                                ...
                                <div class="col-md-4">
                                    <div class="input-group">
                                        <span class="input-group-addon">{{ get_option('currency_sign') }}</span>
                                        <input type="text" placeholder="@lang('app.ex_price')" class="form-control" name="discount_price" id="price">
                                    </div>
                                </div>
                                <div class="col-sm-8 col-md-offset-4">
                                    {!! $errors->has('price')? '<p class="help-block">'.$errors->first('price').'</p>':'' !!}
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" id="seller_url" name="seller_url" placeholder="@lang('app.seller_url')">
                                </div>
                            </div>
